...
On my work i usually to use Flask/fastapi for building a backend service, packing my service using docker, connect my whole service using nginx, deploy that manually using github webhook trigger, and still learn how to be better than that. :dart:
